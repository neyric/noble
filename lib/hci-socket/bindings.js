...
NobleBindings.prototype.onLeLtkNegReply = function(handle) {
  if (this._aclStream) {
...
/*NobleBindings.prototype.setServices = function(services) {
  for(var handle in this._gatts) {
    this._gatts[handle].setServices(services);
  }
...
NobleBindings.prototype.write = function(peripheralUuid, serviceUuid, characteristicUuid, data, withoutResponse) {
  ...
  if (gatt) {
    console.log('gatt write', serviceUuid, characteristicUuid, data, withoutResponse);
