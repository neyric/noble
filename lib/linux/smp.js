...
/*Smp.prototype.handlePairingRequest = function() {
...
Smp.prototype.sendPairingRequest = function() {
  ...
  this._preq = new Buffer([
    ...
    0x01, // Authentication requirement: Bonding - No MITM
    0x10, // Max encryption key size
    0x01, // Initiator key distribution: <none>
    0x07  // Responder key distribution: EncKey
  ]);
...
Smp.prototype.sendPairingConfirm = function () {
  var confirmKey = crypto.c1(this._tk, this._r, this._preq, this._pres, this._iat, this._ia, this._rat, this._ra);
